...
export default function PrivacyPage() {
    ...
    useEffect(() => {
        const fetchContent = async () => {
            try {
                const data = await contentApi.getContent('privacy');
                setContent(data);
            } catch (error) {
            ...
            <div className="max-w-4xl mx-auto">
                <div className="text-center mb-12 animate-fade-in">
                    ...
                    <p className="text-lg text-slate-600 dark:text-slate-400 font-light max-w-2xl mx-auto leading-relaxed">
                        Your privacy is our priority. Last updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}
                    </p>
                </div>
                    ...
                    <div className="p-8 md:p-16">
                        ...
                        <div className="pt-12 mt-16 border-t border-slate-100 dark:border-slate-800/60 text-center">
                            <p className="text-sm text-slate-400 dark:text-slate-500 italic font-light">
                                If you have any questions about this Privacy Policy, please contact us at support@swapaholic.com
                            </p>
                        </div>
                    </div>
                </div>
