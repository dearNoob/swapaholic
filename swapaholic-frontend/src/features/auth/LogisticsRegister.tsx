...
export const LogisticsRegister = () => {
    ...
    if (isRegistered) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900 py-12 px-4">
                <div className="max-w-md w-full text-center space-y-6 animate-fade-in">
                    ...
                    <div className="bg-slate-800/50 backdrop-blur-sm p-6 rounded-xl border border-teal-700/30">
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-teal-900 to-slate-900 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8 animate-fade-in">
                ...
                <form className="mt-8 space-y-5 bg-slate-800/50 backdrop-blur-sm p-8 rounded-xl border border-teal-700/30 shadow-2xl" onSubmit={handleSubmit(onSubmit)}>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="John"
                                {...register('firstName')}
                                className="appearance-none rounded-lg block w-full px-4 py-3 bg-slate-700/50 border border-slate-600 placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
                            />
                    ...
                    <div>
                        ...
                        <input
                            ...
                            {...register('email')}
                            className="appearance-none rounded-lg block w-full px-4 py-3 bg-slate-700/50 border border-slate-600 placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all"
                        />
                    ...
                    <div>
                        <label htmlFor="address" className="block text-sm font-medium text-gray-300 mb-1">Address (Optional)</label>
                        <input
                            id="address"
                            type="text"
                            disabled={isLoading}
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            {...register('password')}
                            className="appearance-none rounded-lg block w-full px-4 py-3 bg-slate-700/50 border border-slate-600 placeholder-gray-500 text-white focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all pr-12"
                        />
