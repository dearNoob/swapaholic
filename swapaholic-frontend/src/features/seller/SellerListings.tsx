                ...
                <div className="bg-white shadow overflow-hidden sm:rounded-lg">
                    {isLoading ? (
                        <div className="w-full">
                            ...
                            <div className="bg-gray-50 px-6 py-3 border-b border-gray-200 flex justify-between hidden sm:flex">
                            ...
                            <div className="divide-y divide-gray-200">
                                {[...Array(5)].map((_, i) => (
                                    <div key={i} className="px-6 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 animate-pulse">
